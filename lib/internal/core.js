...
exports.getIPNurl = async function () {
    ...
    response = await axios.get(GET_IPN_URL, payload, {
      headers: headers,
    });
    console.log(response);
 ...
 */
exports.getTransactionStatus = async function (options) {
    payload = {};
    headers = {
      "Content-Type": "application/json",
      Accept: "application/json",
    ...
    response = await axios.get(GET_TRANSACTION_STATUS +"?orderTrackingId="+options.orderTrackingId, payload, {
      headers: headers,
    });
